  ...
  <div>
    ...
    <div class="navbar">
        ...
        <div class="navbar-menu-container">
            ...
            <a href="javascript:void(0)" class="navbar-link" v-text="'Hello, '+nickName" v-if="nickName"></a>
            <a href="javascript:void(0)" class="navbar-link" @click="isLogin=false" v-if="!nickName">Login</a>
        ...
        <div class="md-modal modal-msg md-modal-transition" :class="{'md-show':!isLogin}" >
          <div class="md-modal-inner">
            <div class="md-top">
              ...
              <button class="md-close" @click="isLogin=true">Close</button>
            </div>
        ...
        <div class="md-overlay" v-if="!isLogin" @click="isLogin=true"></div>
    </header>
  </div>
</template>
